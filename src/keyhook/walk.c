...
/*   Updated: 2025/04/19 11:27:42 by pchateau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (param->map->grid[(int)param->player->y][(int)(param->player->x + param->player->dir_x * move_speed)] != '1')
		param->player->x += param->player->dir_x * move_speed;
	if (param->map->grid[(int)(param->player->y + param->player->dir_y * move_speed)][(int)param->player->x] != '1')
...
{
	if (param->map->grid[(int)param->player->y][(int)(param->player->x + param->player->plane_x * move_speed)] != '1')
		param->player->x += param->player->plane_x * move_speed;
	if (param->map->grid[(int)(param->player->y + param->player->plane_y * move_speed)][(int)param->player->x] != '1')
