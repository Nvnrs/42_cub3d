...
/*   Updated: 2025/04/14 10:44:39 by nveneros         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_bool	elements_are_valid(char *file)
{
	...
	while (elements[i])
	{
		...
		// if (is_texture(tab[i]->key) && !try_to_load_texture(tab[i]->val))
		// 	return (print_error_details("The Texture is not supported.\n", tab[i]->val));
